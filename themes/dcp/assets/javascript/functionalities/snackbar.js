 ...
 * @param {string} [type='success'] - O tipo de snackbar ('success' ou 'error').
...
export function showDashboardSnackbar(message, type = 'success', duration = 3000) {
    ...
    snackbar.classList.remove('is-success', 'is-error');
    snackbar.classList.add(type === 'success' ? 'is-success' : 'is-error');
