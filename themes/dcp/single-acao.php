                ...
                <div class="acao-conteudo">
                    ...
                    */
                    ...
                    <section class="formulario-participar">
                        ...
                        <form id="formParticiparAcao" class="form-participar" action="javascript:void(0);" method="post" data-action="<?php bloginfo('url'); ?>/wp-admin/admin-ajax.php" novalidate>
                            ...
                            <div id="cf7-snackbar-error" class="snackbar modal" style="display:none;">
                                <span>Você precisa preencher os campos obrigatórios para confirmar sua participação.</span>
                                <button type="button" class="modal-close">&times;</button>
                            </div>

                            <!-- Modal de sucesso -->
                            <div id="cf7-snackbar-success" class="snackbar modal" style="display:none;">
                                <span>Participação confirmada com sucesso!</span>
                                <button type="button" class="modal-close">&times;</button>
                            </div>
                        </form>
                    </section>
